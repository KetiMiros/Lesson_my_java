...
public class Main {
        public static void main(String[] args) {
            Notebook note1 = new Notebook("ASUS", "AS567", "white", 15.6f, 128, 2, "Linux", 32000);
            Notebook note2 = new Notebook("Lenovo", "ML987", "black", 13.6f, 128, 4, "Windows", 28000);
            Notebook note3 = new Notebook("Digma", "KI543", "white", 13.3f, 512, 4, "Linux", 29000);
            Notebook note4 = new Notebook("ASUS", "IU456", "black", 14.4f, 128, 4, "Windows", 30000);
            Notebook note5 = new Notebook("Apple", "AP123", "black", 12.8f, 256, 12, "macOS", 120000);
            Notebook note6 = new Notebook("Apple", "AP987", "gray", 12.8f, 128, 8, "macOS", 110000);
            Notebook note7 = new Notebook("Lenovo", "LI487", "white", 14.4f, 128, 4, "Linux", 35000);
            Notebook note8 = new Notebook("ASUS", "AS555","gray", 14.2f, 128, 8, "Linux", 40000);
            Notebook note9 = new Notebook("Apple", "AP666", "white", 15.6f, 256, 16, "macOS", 135000);
            Notebook note10 = new Notebook("Digma", "DI567", "black", 15.2f, 64, 2, "Linux", 26000);
            Notebook note11 = new Notebook("Lenovo", "LE777", "black", 16.2f, 256, 8, "Windows", 70000);
            Notebook note12 = new Notebook("ASUS", "AS333", "white", 15.6f, 256, 4, "Windows", 48000);
